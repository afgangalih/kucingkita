  ...
  return (
    <div className="mt-20">
      <Tabs defaultValue="detail" className="w-full">
        <TabsList className="h-auto w-full justify-start gap-8 rounded-none border-b border-slate-100 bg-transparent p-0">
          <TabsTrigger
            value="detail"
            className="relative h-auto rounded-none border-0 border-b-2 border-transparent bg-transparent px-0 pb-4 pt-0 text-[10px] font-black uppercase tracking-widest text-slate-400 shadow-none transition-all data-[state=active]:border-primary data-[state=active]:bg-transparent data-[state=active]:text-slate-900 data-[state=active]:shadow-none"
          >
            Detail Produk
          </TabsTrigger>
          <TabsTrigger
