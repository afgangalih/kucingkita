    ...
    <div className="mx-auto max-w-[1400px] space-y-10 pb-10">
      <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between border-b border-slate-100 pb-8">
        ...
        <div className="flex gap-3">
          <Button
            variant="outline"
            className="h-14 rounded-2xl border-2 font-bold px-6 hover:bg-slate-50"
          >
            LIHAT SITUS
          </Button>
          <Button
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-1">
              ...
              <p className="text-xs font-medium text-slate-400">
                Submission dari pengguna yang harus diperiksa (FR-10)
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                type: "Review Makanan",
                user: "Siska Kucing",
                item: "Review: Royal Canin Hairball",
                time: "5 jam lalu",
              ...
              <div
                key={i}
                className="flex items-center justify-between p-6 rounded-[2rem] bg-slate-50/50 hover:bg-slate-50 transition-all border border-transparent hover:border-slate-100 group"
              >
                <div className="flex items-center gap-5">
                  <div
                    className={`text-[10px] font-black w-24 uppercase tracking-tighter ${item.color}`}
                  >
                    {item.type}
                  </div>
                  <div>
                ...
                <Button
                  size="sm"
                  className="rounded-full bg-white text-slate-900 border-2 hover:bg-primary hover:text-white hover:border-primary transition-all"
                >
                  Review
                </Button>
              </div>
        ...
        <div className="lg:col-span-2 rounded-[3rem] bg-slate-900 p-10 text-white relative flex flex-col justify-between shadow-2xl">
          <div className="relative z-10 space-y-8">
            ...
            <p className="text-sm text-slate-400 font-medium leading-relaxed">
              Memastikan seluruh konten (Ras, Makanan, Artikel) sudah memiliki
              terjemahan Indonesia & Inggris (FR-09).
            </p>
